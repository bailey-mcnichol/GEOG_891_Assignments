...
## Dr. Bitterman's code reading exercise

l.lake <- "./data/wildcard_friday/lake_champlain"
...
# Creating and naming the function
# 5 arguments
calc_area_by_thresholds <- function(in.raster, boundingPolygon.path, 
                                    start_date, end_date,
                                    lake_transform) {
  
  #boundingPolygon.path <- bb.path
  # setting the path on the user's computer
